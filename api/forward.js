export default async function handler(req, res) {
    ...
    try {
        ...
        const serverInfo = {
            ...
            cacheControl: req.headers['cache-control'] || 'none',
            pragma: req.headers['pragma'] || 'none',
            
            // 安全相關標頭
            xForwardedProto: req.headers['x-forwarded-proto'] || 'unknown',
            xForwardedPort: req.headers['x-forwarded-port'] || 'unknown',
        ...
        const gscriptURL = "https://script.google.com/macros/s/AKfycbxKQIt8ZDNJcuuIDIDtXhKgSuQTt4ANwxbtf1eeOlyjXL8AsCaH_UHYHRbpt--ef4f3/exec";
